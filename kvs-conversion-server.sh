...
[ -n "$NUM_FOLDERS" ] && env_vars+=(-e NUM_FOLDERS="$NUM_FOLDERS")
...
docker run --rm -it --name vsftpd "${env_vars[@]}" -p 21:21 -p 21100-21110:21100-21110 maximemichaud/kvs-conversion-server:latest
